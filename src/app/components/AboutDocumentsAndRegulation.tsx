...
const AboutDocumentsAndRegulation: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-[#FFF4CF] py-20">
      {/*
      ...
      */}
      ...
      <div className="mx-auto max-w-[1200px] px-5">
        <h2 className="font-lora font-semibold text-[48px] leading-[1.28] tracking-[0.01em] text-center text-[#1F1514] mb-10">
          Документи и законски регулативи
        </h2>

        <p className="font-inter font-light text-[20px] leading-[1.4] text-center text-[#1F1514] max-w-[800px] mx-auto mb-10">
        ...
        <div className="flex justify-center">
          <button className="bg-[#F5C322] border border-white rounded-xl px-10 py-4 font-inter font-bold text-[20px] leading-[1.21] text-[#1F1514] cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
            Прочитајте повеќе
          </button>
        </div>
      </div>
