        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-8 md:gap-10 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left order-1 w-full max-w-[600px] lg:max-w-none mx-auto">
            ...
            <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6">
              ...
              >
                Самото селектирање на компаниите не е доволно. Toa е нашиот прв
                чекор. Откако ќе сме длабоко уверени дека сме купиле акции од
                квалитетни компании кои се тргувале по атрактивни цени, ќе треба
                да одлучиме како акциите од тие компании ќе се вклопат во нашето
                портфолио.
              </p>
              <p
                className="text-sm sm:text-base md:text-lg lg:text-xl text-[#1F1514] font-light"
                style={{ lineHeight: "1.4em" }}
              >
                За нивна оптимална алокација во портфолиото ние интерно го
                користиме нашиот софтвер Opfolio Invest кого го развиваме и
                тестираме веќе 10 години.
              </p>
            </div>
          </div>
